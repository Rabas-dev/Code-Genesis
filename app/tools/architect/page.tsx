    ...
    <div className="flex flex-col h-screen bg-background overflow-hidden">
      ...
      <nav className="h-12 border-b border-border flex items-center px-4 gap-3 shrink-0 bg-background/95 backdrop-blur">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className="px-1.5 py-0.5 rounded-full text-[10px] bg-blue-500/15 text-blue-400 border border-blue-500/20 font-medium">
            AI
          </span>
        </div>
        ...
        <div className="ml-auto flex items-center gap-2">
          <p className="text-xs text-muted-foreground hidden md:block">
            Generate system diagrams, DB schema, and API contracts from a description
          </p>
          <button
